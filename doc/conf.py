# -*- coding: utf-8 -*-
#
# twyg documentation build configuration file, created by
# sphinx-quickstart on Fri Aug  9 21:26:43 2013.
#
...
latex_documents = [
  ('index', 'twyg.tex', u'twyg Documentation',
   u'John Novak', 'manual'),
]
...
man_pages = [
    ('index', 'twyg', u'twyg Documentation',
     [u'John Novak'], 1)
]
...
texinfo_documents = [
  ('index', 'twyg', u'twyg Documentation',
   u'John Novak', 'twyg', 'One line description of project.',
   'Miscellaneous'),
]
